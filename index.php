        ...
        <div class="header">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div style="display: flex; gap: 12px; align-items: center;">
                    <?php if (hasPrivilege($user_privs, 'insert_users')): ?>
                    ...
                    <table class="user-table">
                        <thead>
                            <tr>
                                ...
                                <?php if (hasPrivilege($user_privs, 'manage_roles') || hasPrivilege($user_privs, 'update_users') || hasPrivilege($user_privs, 'delete_users')): ?>
                                    ...
                                    <?php if (hasPrivilege($user_privs, 'manage_roles') || hasPrivilege($user_privs, 'update_users') || hasPrivilege($user_privs, 'delete_users')): ?>
                                        <td style="text-align: center;">
                                            <div style="display: flex; justify-content: center;">
                                                <a href="manage_roles.php?user_id=<?php echo $row['id']; ?>" class="btn btn-small btn-secondary" style="padding: 8px 16px;">
